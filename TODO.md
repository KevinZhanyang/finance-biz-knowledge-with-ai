...
- [x] fund/sales/subscription.md — 认购/申购/赎回流程详解（未知价法、确认时效、巨额赎回）
- [ ] fund/sales/fee-structure.md — 费率结构（申购费分档、管理费、托管费、C类费率对比）
- [x] fund/registration/day-end.md — 日终处理全流程
- [x] fund/registration/ta-system.md — TA 系统详解（自建TA vs 中登TA、账户体系、数据交互）
- [x] fund/registration/clearing.md — 清算交收（资金划付流程、清算文件、多级清算）
